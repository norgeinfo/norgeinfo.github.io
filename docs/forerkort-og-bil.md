...
__Информация от Skatteetaten__: [:octicons-link-external-16: Використання автомобіля з іноземними номерами](https://www.skatteetaten.no/person/utenlandsk/informasjon-til-deg-som-er-asylsoker-fra-ukraina2/)
...
- Оформить страховку на автомобиль в Украине, которая действительна в Норвегии <small>(рекомендуемый вариант)</small> 

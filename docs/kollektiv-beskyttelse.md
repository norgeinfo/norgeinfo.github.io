...
## Могу ли я подать заявку о получении коллективной защиты, не находясь в Норвегии?
...
### Как доехать до Национального центра регистрации беженцев? { #rade }

**Из города Осло**

От атобусного терминала (Oslo bussterminal) доехать можно напрямую на экспресс автобусе VY6 (компании-перевозчика Vy):
  ...
  - **Отправление с остановки**: Oslo bussterminal, платформа А6 (уточняйте платформу на месте)
  - **Остановка возле Råde (ближайшая, 202 м от центра регистрации)**: Jonsten E6 

-----

**Из аэропорта Oslo Lufthavn, Gardemoen**

> От аэропорта Oslo Lufthavn, Gardemoen можно доехать бесплатно до автобусного терминала города Осло (Oslo bussterminal) на автобусе номер 400 (компании-перевозчика # Ruter) при [:octicons-link-external-16: наличии паспорта Украины](https://ruter.no/nyheter/gratis-reiser-for-asylsokere/). Автобус отправляется обычно с платформы номер 50 возле аэропорта (уточняйте платформу на месте). Затем вы можете доехать на автобусе VY6, как описано выше. 

- **Vy flybussen FB12** (напрямую):
   
    - **Цена**: От 355 NOK за взрослого (цена может зависить от выбраного дня и времени) при оплате онлайн [:octicons-link-external-16: https://www.vybuss.no/](https://www.vybuss.no/) или с допольнительной наценкой у водителя при посадке в автобус. 
    - **Остановка возле аэропорта**: Платформа 14 (уточняйте платформу на месте)
    - **Остановка возле Råde (ближайшая, 202 м от центра регистрации)**: Jonsten E6 

**Из аэропорта Sandefjord lufthavn, Torp**
...
## Для соискателей, которые живут в частном секторе и не нуждаются в месте в центре приема { #privat }

...
МАМОТ (c норвежского **m**idlertidig **a**lternativ **mot**taksplass) это система для лиц, которые еще не получили вид на жительство в Норвегии. Это касается людей, проживающих в муниципалитете/коммуне, которые входят в группу для получения временной коллективной защиты, но еще не получили ответа на заявление от UDI.
...
На AMOT экономическая помощь не гарантирована, иными словами всем живущим по MAMOT не предусмотрены выплаты. В случае если вы не состоянии сами себя содержать, вам возможно может быть положенна базовая экономическая поддержка. 

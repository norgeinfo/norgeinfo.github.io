...
=== "Gardemoen"
    ...
    Можно так же доехать на поезде до железнодорожного воказала Осло (Oslo S), и далее [сделать пересадку на (платный) транспорт в сторону регистрационного центра Råde](#__tabbed_1_2).
    ...
    Рекомендуется ехать обычным поездом. Обычные поезда — это поезда _RE10_ Asker, _R11_ Skien, _R12_ Kongsberg. Время пути примерно 23 минуты. При поездке на этих поездах вам нужно выйти не остановке _Oslo S_ (железнодорожный вокзал Oslo S). Автобусный терминал Oslo Bussterminal находиться в шаговой доступности от железнодорожного воказала Oslo S [(:octicons-link-external-16: см. карту)](https://www.google.com/maps/dir/Oslo+S,+Jernbanetorget,+Oslo/Oslo+bussterminal,+Schweigaards+gate,+Oslo/@59.9113688,10.7511434,16.71z/data=!4m14!4m13!1m5!1m1!1s0x46416e8a1c253d39:0xe77bcdda7048ef3b!2m2!1d10.7506017!2d59.9108989!1m5!1m1!1s0x46416f45ee701d23:0xb55d0dfcebf2d657!2m2!1d10.757078!2d59.9117567!3e2?entry=ttu)  
    
    Билет на взрослого стоит 118 норвежских крон, и купить его можно  [:octicons-link-external-16: на сайте vy.no](https://www.vy.no/), либо на станции (через кассы или билетные автоматы). При покупке билетов станцию отправление нужно указать _Oslo lufthavn (Gardemoen)_ и станцию прибытия _Oslo S_. Покупать билеты в поезде не рекомендуется. 

    От аэропорта ходят также экспресс поезда компании Flytoget, но стоит дороже, 230 норвежский крон на взрослого. Поэтому рекомендуется пользоваться обычными поездами.
    ...
    - _Цена_: От 355 NOK за взрослого [:octicons-link-external-16: при покупки билета онлайн на сайте https://www.vybuss.no/](https://www.vybuss.no/) или с допольнительной наценкой у водителя при посадке в автобус. Цена может зависить от выбраного дня и времени.
...
=== "Oslo"
    ...
    - __Остановка возле Råde (3 километра от центра регистрации)__: Råde stasjon
...
=== "Torp (Sandefjord)"
    ...
    Экспресс автобус от Torp до автобусного терминала Oslo Bussterminal. 
    
    Автобус отправляется 45 минут после прилета самолета в аэропорт, расписание можно узнать на сайте, указанным ниже в пункте "Где купить билеты". 
    
    - __Название автобуса__: Torpexpress 
    - __Цена__: 390 норвежских крон (взрослый билет). 
     - __Где купить билеты__: На сайте [:octicons-link-external-16: https://www.torpekspressen.no/](https://www.torpekspressen.no/). Билеты у водителя продаються только если есть свободные места.
    ...
    От аэропорта Torp ходит автобус-шаттл до ближайшей железнодорожной станции Torp. Шаттл идет 4 минуты.

    На станции Torp нужно сесть на поезд до Oslo S (железнодорожный воказал), это поезд RE11 Eidsvoll. Время в пути примерно 1 час 40 минут.

    Комбинированный билет на шаттл и на поезд на взрослого стоит 364  норвежских крон, и купить его можно на сайте [vy.no](https://www.vy.no/). При покупке билетов станцию отправление нужно указать _Sandefjord lufthavn Torp_ и станцию прибытия _Oslo S_. 
